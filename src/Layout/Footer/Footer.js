...
const Footer = (props) => (
    ...
    <a href="mailto:anirudhv@purdue.edu" class={modules.SocialMedia}><i class="fa fa-envelope"></i></a>
  	<a href="https://www.linkedin.com/in/anirudh-venkataramanan-2811651a5/" class={modules.SocialMedia}><i class="fa fa-linkedin"></i></a>
  	<a href="https://github.com/anirudhv" class={modules.SocialMedia}><i class="fa fa-github"></i></a>
	</div>
);
